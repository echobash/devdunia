...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const emojiData = [
        ...
        { emoji: '👋', unicode: 'U+1F44B', name: 'waving hand', category: 'hands' },
        { emoji: '🤚', unicode: 'U+1F91A', name: 'raised back of hand', category: 'hands' },
        { emoji: '🖐️', unicode: 'U+1F590 U+FE0F', name: 'hand with fingers splayed', category: 'hands' },
        { emoji: '✋', unicode: 'U+270B', name: 'raised hand', category: 'hands' },
        { emoji: '🖖', unicode: 'U+1F596', name: 'vulcan salute', category: 'hands' },
        { emoji: '👌', unicode: 'U+1F44C', name: 'OK hand', category: 'hands' },
        { emoji: '🤏', unicode: 'U+1F90F', name: 'pinching hand', category: 'hands' },
        { emoji: '✌️', unicode: 'U+270C U+FE0F', name: 'victory hand', category: 'hands' },
        { emoji: '🤞', unicode: 'U+1F91E', name: 'crossed fingers', category: 'hands' },
        { emoji: '🤟', unicode: 'U+1F91F', name: 'love-you gesture', category: 'hands' },
        { emoji: '🤘', unicode: 'U+1F918', name: 'sign of the horns', category: 'hands' },
        { emoji: '🤙', unicode: 'U+1F919', name: 'call me hand', category: 'hands' },
        { emoji: '👈', unicode: 'U+1F448', name: 'backhand index pointing left', category: 'hands' },
        { emoji: '👉', unicode: 'U+1F449', name: 'backhand index pointing right', category: 'hands' },
        { emoji: '👆', unicode: 'U+1F446', name: 'backhand index pointing up', category: 'hands' },
        { emoji: '🖕', unicode: 'U+1F595', name: 'middle finger', category: 'hands' },
        { emoji: '👇', unicode: 'U+1F447', name: 'backhand index pointing down', category: 'hands' },
        { emoji: '☝️', unicode: 'U+261D U+FE0F', name: 'index pointing up', category: 'hands' },
        { emoji: '👍', unicode: 'U+1F44D', name: 'thumbs up', category: 'hands' },
        { emoji: '👎', unicode: 'U+1F44E', name: 'thumbs down', category: 'hands' },
        { emoji: '✊', unicode: 'U+270A', name: 'raised fist', category: 'hands' },
        { emoji: '👊', unicode: 'U+1F44A', name: 'oncoming fist', category: 'hands' },
        { emoji: '🤛', unicode: 'U+1F91B', name: 'left-facing fist', category: 'hands' },
        { emoji: '🤜', unicode: 'U+1F91C', name: 'right-facing fist', category: 'hands' },
        { emoji: '👏', unicode: 'U+1F44F', name: 'clapping hands', category: 'hands' },
        { emoji: '🙌', unicode: 'U+1F64C', name: 'raising hands', category: 'hands' },
        { emoji: '👐', unicode: 'U+1F450', name: 'open hands', category: 'hands' },
        { emoji: '🤲', unicode: 'U+1F932', name: 'palms up together', category: 'hands' },
        { emoji: '🤝', unicode: 'U+1F91D', name: 'handshake', category: 'hands' },
        { emoji: '🙏', unicode: 'U+1F64F', name: 'folded hands', category: 'hands' },
        { emoji: '✍️', unicode: 'U+270D U+FE0F', name: 'writing hand', category: 'hands' },
        { emoji: '💅', unicode: 'U+1F485', name: 'nail polish', category: 'hands' },
        { emoji: '🤳', unicode: 'U+1F933', name: 'selfie', category: 'hands' },
        { emoji: '💪', unicode: 'U+1F4AA', name: 'flexed biceps', category: 'hands' },
        { emoji: '🦾', unicode: 'U+1F9BE', name: 'mechanical arm', category: 'hands' },
        { emoji: '🦿', unicode: 'U+1F9BF', name: 'mechanical leg', category: 'hands' },
        { emoji: '🦵', unicode: 'U+1F9B5', name: 'leg', category: 'hands' },
        { emoji: '🦶', unicode: 'U+1F9B6', name: 'foot', category: 'hands' },
        { emoji: '👂', unicode: 'U+1F442', name: 'ear', category: 'hands' },
        { emoji: '🦻', unicode: 'U+1F9BB', name: 'ear with hearing aid', category: 'hands' },
        { emoji: '👃', unicode: 'U+1F443', name: 'nose', category: 'hands' },
        { emoji: '🧠', unicode: 'U+1F9E0', name: 'brain', category: 'hands' },
        { emoji: '🦷', unicode: 'U+1F9B7', name: 'tooth', category: 'hands' },
        { emoji: '🦴', unicode: 'U+1F9B4', name: 'bone', category: 'hands' },
        { emoji: '👀', unicode: 'U+1F440', name: 'eyes', category: 'hands' },
        { emoji: '👁️', unicode: 'U+1F441 U+FE0F', name: 'eye', category: 'hands' },
        { emoji: '👅', unicode: 'U+1F445', name: 'tongue', category: 'hands' },
        { emoji: '👄', unicode: 'U+1F444', name: 'mouth', category: 'hands' }
    ];
